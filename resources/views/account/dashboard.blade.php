...
<!--  <select>
  <option value="class="active"><a href="#profile" data-toggle="tab">Student Info</a></option>
  <option value="class="active"><a href="#profile" data-toggle="tab">Employee Info</a></option>
  <option value="<li class="active"><a href="#profile" data-toggle="tab">Parent Info</a></option>
 </select>
 -->
              <li class="active"><a href="#profile" data-toggle="tab">User Info</a></li>
              <!-- <li class="active"><a href="#profile" data-toggle="tab">Employee Info</a></li>
              <li class="active"><a href="#profile" data-toggle="tab">Parent Info</a></li> -->
