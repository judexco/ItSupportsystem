...
@section('content')
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <a class="btn bg-purple" href="{{ route('admin.categorys.create') }}"> Create New Category</a>
    </section>
                  ...
                  <tr>
                    ...
                    <td>{{ $category->name }}</td>
                     ...
                     <td>
                      ...
                      <!--  <td><a href="{{ route('admin.categorys.show',$category->id) }}">{{ $category->name }}</a></td>
                     <td> -->


                      <a href="{{ route('categorys.edit',$category->id) }}" class="btn btn-sm btn-flat btn-primary"><span class='fa fa-pencil' aria-hidden='true'></span> <b>Edit</b></a>
                    
                      <!-- <form class="form-group" action="{{url('/categorys'.$category->id.'/')}}" method="post">
                        {{csrf_field()}}
                        {{method_field('DELETE')}}
